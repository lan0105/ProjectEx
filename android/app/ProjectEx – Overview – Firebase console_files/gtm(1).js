...
var Md=[E.B,E.F],Nd=function(a){var b=a[E.Zd];b&&Ac(40);var c=a[E.$d];c&&Ac(41);for(var d=Ba(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==E.Zd&&f!==E.$d)if(-1<m(Md,f)){var h=f,k=a[f],l=d[e];xd().set(h,k,l,"VN","VN-HN",c)}else{}},Od=function(a,
...
function Qq(a,b){}var Z={g:{}};Z.g.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.h="ctv";Z.__ctv.i=!0;Z.__ctv.priorityOverride=0})(function(){return"3"})}();
...
q.vtp_enableLinkId&&D("require","linkid","linkid.js");D("set","hitCallback",function(){var la=y&&y.hitCallback;va(la)&&la();q.vtp_gtmOnSuccess()});var V=function(la,U){return void 0===q[la]?u[U]:q[la]};if("TRACK_EVENT"==q.vtp_trackType){}else if("TRACK_SOCIAL"==q.vtp_trackType){}else if("TRACK_TRANSACTION"==
